...
Route::add('GET','/loan_list_all', [Controller\LoanController::class, 'loan_list_all'])->middleware('librarian');
Route::add('POST','/delete_loan', [Controller\LoanController::class, 'delete_loan'])->middleware('librarian');
